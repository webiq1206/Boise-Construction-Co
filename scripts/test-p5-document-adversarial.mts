...
try{
 ...
 ['unreadable document page marked complete', 'document', (v:any)=>({...v,coverage:{complete:true,pages:[{page:1,status:'unreadable'}]}})],
  ['missing review page', 'review', (v:any)=>({...v,result:{...v.result,documentCoverage:{...v.result.documentCoverage,pages:[]}}})],
  ['duplicate review pages', 'review', (v:any)=>({...v,result:{...v.result,documentCoverage:{...v.result.documentCoverage,expectedPages:2,pages:[v.result.documentCoverage.pages[0],v.result.documentCoverage.pages[0]]}}})],
  ['review page has partial evidence', 'review', (v:any)=>({...v,result:{...v.result,documentCoverage:{...v.result.documentCoverage,pages:[{...v.result.documentCoverage.pages[0],status:'partial'}]}}})],
  ['review page refers to another source', 'review', (v:any)=>({...v,result:{...v.result,documentCoverage:{...v.result.documentCoverage,pages:[{...v.result.documentCoverage.pages[0],source:'different.pdf'}]}}})],
  ['review page number is wrong', 'review', (v:any)=>({...v,result:{...v.result,documentCoverage:{...v.result.documentCoverage,pages:[{...v.result.documentCoverage.pages[0],page:7}]}}})],
