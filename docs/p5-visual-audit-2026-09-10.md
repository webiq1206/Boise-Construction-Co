# Boise Construction Co: P5 family visual audit, September 10, 2026

Site: https://boiseconstruction.co. Recorded routes for this repository: 172.
...
- Restricted Handyman city image rotations to the advertised trade, included Garden City in the same mapping, and narrowed Construction lot-evaluation and shop-home imagery to relevant service stages. Related city pages intentionally reuse suitable representative images instead of unrelated substitutes.
...
The consolidated production route sweep and targeted reruns passed **1548 of 1548 route/viewport checks** (172 recorded routes at nine widths), with no recorded horizontal overflow, broken visible images, page exceptions, or console errors. All 10 route batches completed their internal-link checks without failures. [Full route workflow](https://github.com/webiq1206/Boise-Construction-Co/actions/runs/34520559493) tested `0d5114a91df55c09b51cd13246967ff0f245cc87`.

The subsequent final component build passed **108 of 108 checks**, including responsive menus, sticky actions and form clearance, comparison input and sizing, and balanced cards. [Final component workflow](https://github.com/webiq1206/Boise-Construction-Co/actions/runs/34522956694) tested `6e40686c3aec3eeb838b4c4c87761cc730a02491`. Additional results: browser-results: 9 passing scenarios; launcher-results: 9 passing scenarios; mobile-navigation: 15 passing scenarios.
...
Supplemental route workflows: [run 34522525616](https://github.com/webiq1206/Boise-Construction-Co/actions/runs/34522525616) at `55c430f9eab7366eea3b117381e196c7955e93ae`. Each row in the CSV identifies its actual tested source and run.

2 earlier failed checks are retained in the interaction JSON. The final route table uses the later passing rerun for each affected route and viewport.
