...
function IncludedSection({ included, project }: { included: string[]; project?: ProjectType | null }) {
  ...
  return (
    <div data-testid="typically-included-section">
      ...
      >
        <span className="text-xs font-normal text-inverse-foreground/90">
      ...
      {open && (
        <div id={panelId} className="pt-2">
          ...
          <p className="text-xs leading-relaxed text-inverse-muted">{INCLUDED_SCOPE_NOTE}</p>
          {project === "kitchen" && (
            <p
              className="text-xs leading-relaxed text-inverse-muted mt-1.5"
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-3">
        ...
        {result && (
          <div className="text-xs tracking-wide uppercase px-2 py-1 rounded-sm bg-inverse-foreground/15 text-inverse-foreground/90">
      ...
      {result ? (
        <>
          ...
          <div className="mb-4">
            <div className="flex justify-between text-xs mb-1.5 text-inverse-muted">
            ...
            <p className="text-xs text-inverse-muted mt-1.5">
          ...
          <p className="text-xs text-center text-inverse-muted mb-2">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-1 text-xs text-inverse-muted/80 hover:text-inverse-muted"
          >
          ...
          {legalOpen && (
            <p
              ...
              className="text-xs leading-relaxed text-inverse-muted mt-2"
            >
        ...
        <>
          ...
          <p className="text-xs leading-relaxed text-inverse-muted border-t border-inverse-foreground/10 pt-4">
