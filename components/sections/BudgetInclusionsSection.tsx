    ...
    >
      ...
      <div className="ed-shell relative z-10">
        <div className="ed-split ed-split-end">
          ...
          <Reveal delay={60}>
            <p className="ed-body">
              A planning range upfront, a line-item budget before we break ground,
              and the same standard inclusions on every home - so you always know
              where things stand.
            </p>
          </Reveal>
        </div>
        ...
        <Reveal delay={120}>
          <div className="ed-inset mt-[clamp(32px,4vw,56px)] grid gap-[var(--ed-gutter)] lg:grid-cols-[1.1fr_0.9fr]">
            <div>
              <p className="ed-eyebrow">Included on every home we build</p>
