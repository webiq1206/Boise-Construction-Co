            ...
            <div className="flex items-center gap-2 min-w-0 flex-1">
              ...
              {isPurchased && (
                <>
                  ...
                  />
                  <Badge variant="default" className="text-xs px-1.5 py-0 flex-shrink-0">
                    Purchased
                  </Badge>
                </>
              )}
              {isPurchased && (() => {
                ...
                return (
                  <Badge
                    variant="outline"
                    className="text-xs px-1.5 py-0 flex-shrink-0 text-muted-foreground"
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-1.5 flex-wrap">
                  ...
                  {!isPurchased && hasTimeDiscount && (
                    <Badge variant="outline" className="text-xs px-1.5 py-0 text-primary border-primary">
                      Price Reduced
                    </Badge>
                  )}
                ...
                <div className="text-xs mt-0.5 flex items-center gap-1 font-semibold text-emerald-700 dark:text-emerald-400">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div className="flex items-center gap-1.5">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-xs leading-tight">Est. value</p>
              </div>
            </div>
            <div className="flex items-center gap-1.5">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-xs leading-tight">{getLeadFrequencyDisplay(lead)} service</p>
              </div>
            </div>
          </div>
