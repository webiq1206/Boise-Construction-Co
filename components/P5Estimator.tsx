...
import {SCOPE_FIELDS,SCOPE_FILE_LIMIT,SCOPE_PAGE_LIMIT,SCOPE_BATCH_LIMIT,SCOPE_FILE_COUNT,SCOPE_UPLOAD_HELP,type ScopeField,type ScopeAnswers,type ScopeUpload} from '@/lib/p5/scope';
...
export function P5Estimator({defaultService='',headingAs='h1',projectSource,layout='embedded',onExit}:P5EstimatorProps){
  ...
  const dock=locked&&stage!==2&&stage!==3?<div className={styles.dockHint} role="status">Working on your project. Your progress is saved.</div>
    ...
    :<>{composer}{stage===0&&<p className={styles.dockHint}>PDFs up to {SCOPE_PAGE_LIMIT} pages, images, Word, spreadsheets and text. Up to 50 files, 250 MiB each and 1 GiB total. Instructions such as “price only the trim” or “exclude plumbing” are followed throughout.</p>}</>;
