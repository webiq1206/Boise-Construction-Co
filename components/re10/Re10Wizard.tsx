...
function ResultView({
  ...
  return (
    <>
      ...
      <div data-wizard-action-bar="" className="sticky bottom-0 z-30 -mx-4 mt-8 border-t border-inverse-foreground/15 bg-[hsl(var(--inverse))]/95 px-4 pb-safe pt-3 backdrop-blur-md">
