        ...
        <div className="relative z-10 w-full container px-4 pb-14 md:pb-20 pt-10 fade-up">
          ...
          {planningFrom && (
            <p className="mt-6 flex flex-wrap items-baseline gap-x-2 gap-y-1 text-sm text-inverse-foreground/80">
              <span className="uppercase tracking-[0.12em] text-xs">Planning from</span>
                    ...
                    <MarketingCard className="overflow-hidden h-full">
                      <div className="grid grid-cols-2">
                        <div className="relative aspect-[4/3]">
                          ...
                          />
                          <span className="absolute bottom-1 left-1 text-xs uppercase tracking-wide bg-inverse/70 text-inverse-foreground px-1.5 py-0.5 rounded">
                            Before
                          </span>
                        </div>
                        <div className="relative aspect-[4/3]">
                          <Image
                            ...
                            className="object-cover"
                          />
                          <span className="absolute bottom-1 left-1 text-xs uppercase tracking-wide bg-accent text-accent-foreground px-1.5 py-0.5 rounded">
                            After
                          </span>
                        </div>
                      </div>
