...
export const BATHROOM_PILLAR = buildPillarGuide({
  ...
  metaDescription:
    'Master bath and guest bath remodeling in Boise: showers, layouts, aging-in-place, ROI, and permits.',
...
export const ADDITION_PILLAR = buildPillarGuide({
  ...
  metaDescription: 'Room additions, second stories, ADUs, and garage conversions in Boise and the Treasure Valley.',
...
export const PROCESS_CLUSTER_POSTS: BlogPostData[] = processSlugs.map(([slug, title]) =>
  buildClusterPost({
    ...
    title,
    seoTitle: title,
    metaDescription: `${title} for Ada and Canyon County remodels.`,
    excerpt: title,
    hubSlug: 'remodeling-process',
    tags: ['process', 'permits'],
...
export const ROI_PILLAR = buildPillarGuide({
  ...
  metaDescription: 'Which remodels return value in Boise, Meridian, and Eagle resale markets.',
...
const roiSlugs = [
  ['kitchen-roi-remodeling', 'Kitchen ROI'],
  ['bathroom-roi-remodeling', 'Bathroom ROI'],
...
export const OUTDOOR_PILLAR = buildPillarGuide({
  ...
  metaDescription:
    'Outdoor kitchens, covered patios, decks vs patios, fireplaces, and backyard entertaining in Idaho’s dry climate.',
...
export const OUTDOOR_CLUSTER_POSTS: BlogPostData[] = outdoorSlugs.map(([slug, title]) =>
  buildClusterPost({
    ...
    title,
    seoTitle: title,
    metaDescription: `${title} for Boise-area homeowners.`,
...
export const LOCATION_GUIDES: GuidePageData[] = [
  buildLocationGuide({
    ...
    metaDescription: 'Remodeling in Meridian, Idaho: permits, housing types, and local services.',
  ...
  buildLocationGuide({
    ...
    metaDescription: 'Remodeling on the Boise Bench.',
  ...
  buildLocationGuide({
    ...
    metaDescription: 'Remodeling in Harris Ranch Boise.',
